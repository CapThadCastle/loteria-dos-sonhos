const dicionario = {
  ...
  13: ["azar","galinha","galo","morte","treze","cemitério","medo","terror","assombração"],
...
ETAPA 1 — CORREÇÃO DO TEXTO:
O usuário pode ter escrito o sonho com erros de português, gírias ou texto confuso. Antes de interpretar, reescreva internamente o sonho de forma clara e coerente, mantendo todos os elementos, símbolos e situações descritos. Não invente elementos que não foram mencionados.

DICIONÁRIO DE PALAVRAS x NÚMEROS:
${dicionarioStr}

SONHO DO JOGADOR (pode conter erros):
"${sonho}"
...
1. Use o sonho corrigido para interpretar profundamente
2. Cruze com o dicionário fornecido
3. Use numerologia e simbolismo para complementar
...
{
  "sonhoCorrigido": "versão corrigida e reescrita do sonho",
